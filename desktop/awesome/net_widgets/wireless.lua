...
local function worker(args)
    ...
    local function net_update()
        ...
        if signal_level == nil then
            ...
            connected = true
            net_text:set_markup(" <span color='#45403D'>|</span>  <span color='#908F32'> </span> <span color='#45403D'>|</span>" )
	    if signal_level > 60 then
            	net_text:set_markup(" <span color='#45403D'>|</span>  <span color='#908F32'> </span> <span color='#45403D'>|</span>" )
	    elseif signal_level > 40 then
            	net_text:set_markup(" <span color='#45403D'>|</span>  <span color='#af652f'> </span> <span color='#45403D'>|</span>" )
            elseif signal_level > 0 then
            	net_text:set_markup(" <span color='#45403D'>|</span>  <span color='#943C28'> </span> <span color='#45403D'>|</span>" )
	    end
	end
    end
    net_update()
