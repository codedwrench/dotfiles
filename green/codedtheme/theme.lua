...
theme.fg_focus   = "#7EB3B3"
theme.fg_urgent  = "#CC9393"
theme.bg_normal  = "#2E3030"
theme.bg_focus   = "#1E1F1F"
theme.bg_urgent  = "#1A130F"
theme.bg_systray = theme.bg_normal
theme.wibox_bg_normal = "#2E3030"
...
-- {{{ Titlebars
theme.titlebar_bg_focus  = "#a2b8b6"
...
-- Example:
theme.tasklist_bg_focus = "#2e3030"
theme.tasklist_fg_focus = "#7eb3b3"
-- }}}
