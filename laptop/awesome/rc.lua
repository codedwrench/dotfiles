...
beautiful.init("/usr/share/awesome/themes/codedtheme/theme.lua")

-- This is used later as the default terminal and editor to run.
terminal = "termite"
editor = os.getenv("EDITOR") or "termite"
...
for s = 1, screen.count() do
	...
	-- Create the wibox
	mywibox[s] = awful.wibox({ position = "bottom", screen = s, bg = beautiful.wibox_bg_normal })
...
awful.key({ }, "XF86KbdBrightnessUp", function() awful.util.spawn("/home/codedwrench/.scripts/leds_up.sh") end),
awful.key({ }, "XF86KbdBrightnessDown", function() awful.util.spawn("/home/codedwrench/.scripts/leds_down.sh") end),
...
awful.rules.rules = {
	...
	-- Set Pavucontrol to always float
...
client.connect_signal("focus", function(c) c.border_color = "D98E4D" end)
client.connect_signal("unfocus", function(c) c.border_color = "B8653D" end)
-- }}}
